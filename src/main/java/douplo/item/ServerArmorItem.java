...
public class ServerArmorItem extends ServerOnlyItem implements Wearable {
    ...
    public static final Serializer<ServerArmorItem> SERIALIZER = new Serializer<ServerArmorItem>() {
        @Override
        public ServerArmorItem fromJson(Identifier id, JsonObject json, DeserializationData data) {
    ...
    public ServerArmorItem(Identifier id, ArmorMaterial material, EquipmentSlot slot, Item.Settings settings, Item clientItem) {
        super(id, settings.maxDamageIfAbsent(material.getDurability(slot)), clientItem);
        this.type = material;
        this.slot = slot;
